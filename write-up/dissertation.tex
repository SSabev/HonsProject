...
Overall, I was pleasantly surprised by the results. On the full set of 987 destinations, the first iteration of my model generated better predictions and scored lower RMSE on 614 of the destinations. On the other hand the in-house champion Last 4 Fridays performed better on 373 of the destinations. In order to illustrate that difference there is a scatter plot of the RMSEs in Figure 1.3. That means that my model is better on 62\% of all the destinations.
...
Aplha & $>$ 0 Weights CF & RMSE TCF & $>$ 0 Weights DF & RMSE TDF & RMSE L4F  \\
\hline
