...
if __name__ == '__main__':
    ...
    for i in glob.glob('tidydata/joined/*.csv'):
        ...
        def get_fridays():
            for forecastdate in data.Date[30:]:
        ...
        Xinput = zip(data.Count.tolist(), data.Friday1.tolist(), data.Friday2.tolist(),data.Friday3.tolist(),data.Friday4.tolist())[30:]
        
        Youtput = data.Searches.tolist()[30:]
        ...
        predicted_w_t = data.PredictedSearches[30:]
        predicted_l4f = data.LF4Predicted[30:]
        actual = data.Searches[30:]
